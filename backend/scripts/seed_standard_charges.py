...
async def seed_standard_charges():
    ...
    async with async_session() as session:
        ...
        if system_company:
            print(f"[OK] SYSTEM company already exists (id={system_company.id})")
        else:
            ...
            await session.flush()
            print(f"[OK] Created SYSTEM company (id={system_company.id})")
        ...
        print("\n[OK] Standard charge master seeded successfully!")
